...
public class GameArena extends JPanel implements Runnable, KeyListener, MouseListener, MouseMotionListener {
	...
	private void init(int width, int height, boolean createWindow) {
		...
		colours.put("LIGHTBLUE", new Color(173, 216, 230, 20));
		colours.put("PENGYBLUE", new Color(10, 20, 90));
		colours.put("SPYBLUE", new Color(30, 50, 90));
		colours.put("ASHINDIGO", new Color(50, 60, 90));
		colours.put("COOLGREY", new Color(68, 85, 90));
		colours.put("CHOCOLATE", new Color(210, 105, 30));
		colours.put("DARKCHOCOLATE", new Color(111, 78, 55));
		colours.put("ALPHA", new Color(255, 255, 255, 0));
		colours.put("ALPHARED", new Color(255, 0, 0, 128));
		...
		synchronized (this) {
			if (!this.exiting) {
				...
				if (backgroundImage != null)
					graphics.drawImage(backgroundImage, 0, 0, arenaWidth, arenaHeight, 0, 0,
